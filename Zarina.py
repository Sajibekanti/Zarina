...
class Login(Tk):
    def __init__(self):
        ...
        if platform.system() == 'Linux':
            ...
            photo = PIL.Image.open('images/login_image.jpg')
    ...
    def contact(self):
        ...
        Label(self.contact, text = 'Sajibekantibd', background = 'white').grid(row = 2, column = 1, sticky = 'w')
...
rar''')
        ...
        self.options['msg'].set('''Your PC Infacted!
